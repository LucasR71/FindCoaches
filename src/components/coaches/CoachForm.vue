<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{ invalid: !description.isValid }">
      ...
      <textarea id="firstname" rows="5" v-model.trim="description.val" />
    ...
    <div class="form-control" :class="{ invalid: !rate.isValid }">
      ...
      <p v-if="!areas.isValid">Select atleast one skill</p>
    </div>
    <p v-if="!formIsValid">
      Please fix the above errors before trying to submit
    </p>
